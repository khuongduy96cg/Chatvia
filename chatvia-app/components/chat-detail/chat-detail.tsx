...
function ChatDetail() {
    return (
        <div className={styles.detail_area}>
            <div className={styles.detail_area_header}>
                ...
                <div className={styles.detail_title}>CodePen Group</div>
                <div className={styles.detail_subtitle}>Created by Aysenur, 1 May 2020</div>
            ...
            <div className={styles.detail_changes}>
                <input type="text" placeholder="Search in Conversation" />
                <div className={styles.detail_change}>
                    Change Color
                    <div className={styles.colors}>
                        <div className={`${styles.color} ${styles.blue} ${styles.selected}`} data-color="blue"></div>
                        <div className={`${styles.color} ${styles.purple}`} data-color="purple"></div>
                        <div className={`${styles.color} ${styles.green}`} data-color="green"></div>
                        <div className={`${styles.color} ${styles.orange}`} data-color="orange"></div>
                    </div>
                </div>
                <div className={styles.detail_change}>
                    Change Emoji
            ...
            <div className={styles.detail_photos}>
                <div className={styles.detail_photo_title}>
                ...
                <div className={styles.detail_photo_grid}>
            ...
            <a href="https://twitter.com/AysnrTrkk" className={styles.follow_me} target="_blank">
